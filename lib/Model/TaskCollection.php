...
class TaskCollection implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'tasks' => '\Swagger\Client\Model\Task[]',
        'total' => 'int'
    ];
     ...
     * Sets tasks
     *
     * @param \Swagger\Client\Model\Task[] $tasks An array of the tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks.
     *
     * @return $this
     */

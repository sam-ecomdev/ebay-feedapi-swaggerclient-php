 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderTaskCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderTaskCollection';
     ...
     * Sets total
     *
     * @param int $total The total number of order tasks that match the input criteria.
     *
     * @return $this
     */

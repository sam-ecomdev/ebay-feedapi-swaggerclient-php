...
class Task implements ModelInterface, ArrayAccess
{
     ...
     * Sets detailHref
     *
     * @param string $detailHref The path to the call URI used to retrieve the task. This field points to the GetOrderTask URI if the task is for LMS_ORDER_REPORT or will be null if this task is for LMS_ORDER_ACK.
     *
     * @return $this
     */
     ...
     * Sets schemaVersion
     *
     * @param string $schemaVersion The schema version number associated with the task.
     *
     * @return $this
     */

...
# **getLatestResultFile**
> \Swagger\Client\Model\StreamingOutput getLatestResultFile($schedule_id)
...
# **getSchedule**
> \Swagger\Client\Model\UserScheduleResponse getSchedule($schedule_id)
...
[**\Swagger\Client\Model\UserScheduleResponse**](../Model/UserScheduleResponse.md)
...
# **getScheduleTemplate**
> \Swagger\Client\Model\ScheduleTemplateResponse getScheduleTemplate($schedule_template_id)
...
[**\Swagger\Client\Model\ScheduleTemplateResponse**](../Model/ScheduleTemplateResponse.md)
...
# **getScheduleTemplates**
> \Swagger\Client\Model\ScheduleTemplateCollection getScheduleTemplates($feed_type, $limit, $offset)
...
[**\Swagger\Client\Model\ScheduleTemplateCollection**](../Model/ScheduleTemplateCollection.md)
...
# **getSchedules**
> \Swagger\Client\Model\UserScheduleCollection getSchedules($feed_type, $limit, $offset)
...
[**\Swagger\Client\Model\UserScheduleCollection**](../Model/UserScheduleCollection.md)
...
$body = new \Swagger\Client\Model\UpdateUserScheduleRequest(); // \Swagger\Client\Model\UpdateUserScheduleRequest | In the request payload: scheduleName is optional; preferredTriggerHour, preferredTriggerDayOfWeek, preferredTriggerDayOfMonth, scheduleStartDate, scheduleEndDate, and schemaVersion are conditional.
 ...
 **body** | [**\Swagger\Client\Model\UpdateUserScheduleRequest**](../Model/UpdateUserScheduleRequest.md)| In the request payload: scheduleName is optional; preferredTriggerHour, preferredTriggerDayOfWeek, preferredTriggerDayOfMonth, scheduleStartDate, scheduleEndDate, and schemaVersion are conditional. |
